...
dfhc=xr.open_dataset('/CMIP_Databank/CMIP6/regrid/historical/CESM2/r3i1p1f1/mon/TCGI_SD_Amon_CESM2_historical_r3i1p1f1_1950-2014_r180x90.nc')
dfhc=dfhc.resample(time='1AS').mean('time')
dfhc['time']=np.arange(1950,2015)
dfhmr=xr.open_dataset('/CMIP_Databank/CMIP6/regrid/historical/MRI-ESM2-0/r1i1p1f1/mon/TCGI_SD_Amon_MRI-ESM2-0_historical_r1i1p1f1_1950-2014_r180x90.nc')
...
dfhmi=xr.open_dataset('/CMIP_Databank/CMIP6/regrid/historical/MIROC6/r1i1p1f1/mon/TCGI_SD_Amon_MIROC6_historical_r1i1p1f1_1950-2014_r180x90.nc')
pd.date_range(start='1950-12-01',periods=65, freq='AS-DEC')
dfhmi=dfhmi.resample(time='1AS').mean('time')
dfhmi['time']=np.arange(1950,2015)
dfhma1=xr.open_dataset('/CMIP_Databank/CMIP6/regrid/historical/ACCESS-CM2/r2i1p1f1/mon/TCGI_SD_Amon_ACCESS-CM2_historical_r2i1p1f1_1950-2014_r180x90.nc')
pd.date_range(start='1950-12-01',periods=65, freq='AS-DEC')
dfhma1=dfhma1.resample(time='1AS').mean('time')
dfhma1['time']=np.arange(1950,2015)
dfhma2=xr.open_dataset('/CMIP_Databank/CMIP6/regrid/historical/ACCESS-ESM1-5/r1i1p1f1/mon/TCGI_SD_Amon_ACCESS-ESM1-5_historical_r1i1p1f1_1950-2014_r180x90.nc')
pd.date_range(start='1950-12-01',periods=65, freq='AS-DEC')
dfhma2=dfhma2.resample(time='1AS').mean('time')
dfhma2['time']=np.arange(1950,2015)
dfhcan=xr.open_dataset('/CMIP_Databank/CMIP6/regrid/historical/CanESM5/r1i1p1f1/mon/TCGI_SD_Amon_CanESM5_historical_r1i1p1f1_1950-2014_r180x90.nc')
pd.date_range(start='1950-12-01',periods=65, freq='AS-DEC')
dfhcan=dfhcan.resample(time='1AS').mean('time')
dfhcan['time']=np.arange(1950,2015)
dfhcnr=xr.open_dataset('/CMIP_Databank/CMIP6/regrid/historical/CNRM-CM6-1/r1i1p1f2/mon/TCGI_SD_Amon_CNRM-CM6-1_historical_r1i1p1f2_1950-2014_r180x90.nc')
pd.date_range(start='1950-12-01',periods=65, freq='AS-DEC')
dfhcnr=dfhcnr.resample(time='1AS').mean('time')
dfhcnr['time']=np.arange(1950,2015)
dfhfg=xr.open_dataset('/CMIP_Databank/CMIP6/regrid/historical/FGOALS-g3/r1i1p1f1/mon/TCGI_SD_Amon_FGOALS-g3_historical_r1i1p1f1_1950-2014_r180x90.nc')
pd.date_range(start='1950-12-01',periods=65, freq='AS-DEC')
dfhfg=dfhfg.resample(time='1AS').mean('time')
dfhfg['time']=np.arange(1950,2015)
dfhhad=xr.open_dataset('/CMIP_Databank/CMIP6/regrid/historical/HadGEM3-GC31-LL/r1i1p1f3/mon/TCGI_SD_Amon_HadGEM3-GC31-LL_historical_r1i1p1f3_1950-2014_r180x90.nc')
pd.date_range(start='1950-12-01',periods=65, freq='AS-DEC')
dfhhad=dfhhad.resample(time='1AS').mean('time')
dfhhad['time']=np.arange(1950,2015)
dfhip=xr.open_dataset('/CMIP_Databank/CMIP6/regrid/historical/IPSL-CM6A-LR/r8i1p1f1/mon/TCGI_SD_Amon_IPSL-CM6A-LR_historical_r8i1p1f1_1950-2014_r180x90.nc')
pd.date_range(start='1950-12-01',periods=65, freq='AS-DEC')
dfhip=dfhip.resample(time='1AS').mean('time')
dfhip['time']=np.arange(1950,2015)
dfhesh=xr.open_dataset('/CMIP_Databank/CMIP6/regrid/historical/E3SM-2-0/r1i1p1f1/mon/TCGI_SD_Amon_E3SM-2-0_historical_r1i1p1f1_1950-2014_r180x90.nc')
pd.date_range(start='1950-12-01',periods=65, freq='AS-DEC')
...
just_h=add_h_new.TCGI.mean('time').sel(lon=slice(0,358),lat=slice(-89,89))
#gl = ax.gridlines()
vmin = 0.00
vmax = 0.013
...
title = ax.set_title('TCGI mean HIST (1979-2014)', fontsize=10, loc='left')
